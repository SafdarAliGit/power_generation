...
frappe.ui.form.on("Daily Energy Production", {
	refresh(frm) {
        frm.set_query("workstation","daily_energy_production_item", function() {
            return {
                filters: {
...
frappe.ui.form.on("Daily Energy Production Item", {
...
function recalc_row_and_totals(frm, cdt, cdn) {
    ...
    let total_amt = 0;
    (frm.doc.daily_energy_production_item || []).forEach(function(r) {
